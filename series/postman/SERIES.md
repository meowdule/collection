...
**목적:** Collection을 만들고, GET·Params·POST까지 요청을 보내고 저장·재실행하기

| Part | 제목 |
|------|------|
| 2-1 | Collection 만들기 |
| 2-2 | 기본 GET 요청 보내기 |
| 2-3 | Query Params 포함 요청 보내기 |
| 2-4 | Body 데이터 포함 POST 요청 보내기 |
| 2-5 | 요청 저장하고 다시 실행하기 |
...
**목적:** Environment·변수로 URL·토큰을 관리하고, 로그인 후 토큰을 자동 저장·적용하기
...
| 3-4 | 로그인 요청 보내기 |
| 3-5 | 로그인 응답에서 토큰 꺼내기 |
| 3-6 | 토큰을 Environment 변수에 자동 저장하기 (Tests) |
| 3-7 | 다른 요청에 토큰 자동 적용하기 |

### 📕 Vol.4 — Collection Runner로 연속 실행

**목적:** 여러 요청을 묶어 Runner로 연속 실행하고, 데이터 파일·결과까지 확인하기

| Part | 제목 |
|------|------|
| 4-1 | 여러 요청 저장하기 |
| 4-2 | Collection Runner 실행하기 |
| 4-3 | 로그인 → 다음 요청 자동 실행 흐름 만들기 |
| 4-4 | CSV / JSON 데이터로 반복 실행하기 |
| 4-5 | 실행 결과 확인하기 |
