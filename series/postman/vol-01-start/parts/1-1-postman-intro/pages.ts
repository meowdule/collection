...
const body: ContentPageData[] = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        label: '전체 흐름',
        title: 'Vol.1~4 전체 흐름',
        lead: 'Vol.1은 Postman을 처음 여는 것부터 시작해요. 아직 설치도 안 한 상태라도 괜찮아요. Vol.2부터 실제 요청 실습이 시작되고, Vol.3·4로 갈수록 <strong>반복 작업 자동화</strong> 방향으로 이어져요.',
      },
      {
        kind: 'cards-2',
        cards: [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        kind: 'code-block',
        caption:
          '로그인 요청을내면 서버가 이런 형태로 답해요. Vol.3에서 여기서 token을 꺼내 자동 저장하는 법을 다뤄요.',
        code: `{
  "status": "success",
  "user": {
    "id": 1042,
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            body: 'Postman은 상태 코드, 메시지, 데이터를 한 화면에서 보여줘요. “200이면 성공, 401이면 로그인 문제”처럼 응답을 읽는 법을 자연스럽게 익힐 수 있어요.',
          },
          {
            title: '“같은 테스트를 팀원이 다시 해야 하는데 조건을 공유하기 어려워요”',
            body: '요청을 저장해두면 팀원과 동일한 조건으로 다시 실행할 수 있어요. “내가 보낸 요청이 이거예요”를 그대로 넘길 수 있어요.',
          },
        ],
      },
      {
      ...
      {
        kind: 'quote',
        text: '각 파트는 화면을 보면서 직접 실행해 보는 구조예요. 스크린샷을 보면서 같은 화면을 찾아 따라하면 돼요. 이론을 먼저 외우려 하지 않아도 괜찮아요 — 일단 따라하다 보면 자연스럽게 이해돼요.',
      },
      {
        kind: 'tip-box',
      ...
      {
        kind: 'quote',
        text: '브라우저에서 바로 쓸 수도 있고, PC에 설치해서 쓸 수도 있어요. 웹으로 먼저 시작하고 나중에 앱을 설치해도 되고, 처음부터 앱으로 시작해도 돼요. 여는 방법은 Vol.1 <strong>1-2</strong>에서 같이 해요 — 어느 쪽이든 이 자료집 실습은 동일하게 따라할 수 있어요.',
      },
      {
        kind: 'quote',
        text: 'API, Request, Response, Collection, Environment — 처음 등장하는 파트에서 짧게 설명하고 넘어가요. 미리 외우려 하지 않아도 돼요.',
      },
      {
        kind: 'warn-box',
